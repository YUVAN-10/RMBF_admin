...
export default function ReferralEmptyState({ hasFilters, onClearFilters }) {
  return (
    <div className="flex flex-col items-center justify-center rounded-xl border border-dashed border-border bg-card p-10 text-center animate-fade-in">
      ...
      {hasFilters ? (
        <>
          <h2 className="mt-4 text-base font-semibold text-text">No matching referrals found</h2>
        ...
        <>
          <h2 className="mt-4 text-base font-semibold text-text">No referrals yet</h2>
          <p className="mt-1 max-w-sm text-sm text-text-secondary">
            Referrals created by members will appear here.
          </p>
        </>
      )}
    </div>
