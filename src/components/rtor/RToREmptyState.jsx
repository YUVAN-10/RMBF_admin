...
export default function RToREmptyState({ hasFilters, onClearFilters }) {
  return (
    <div className="flex flex-col items-center justify-center rounded-xl border border-dashed border-border bg-card p-10 text-center animate-fade-in">
      ...
      {hasFilters ? (
        <>
          <h2 className="mt-4 text-base font-semibold text-text">No matching R to R records found</h2>
        ...
        <>
          <h2 className="mt-4 text-base font-semibold text-text">No R to R records yet</h2>
          <p className="mt-1 max-w-sm text-sm text-text-secondary">
            R to R connections created by members will appear here.
          </p>
        </>
      )}
    </div>
